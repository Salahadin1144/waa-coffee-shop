...
<body>
	...
	<div class="panel panel-default panel-info"
		...
		<div class="panel-body">
			<form class="form-horizontal" action="/create" method="POST" modelAttribute="newProduct">
				<div class="form-group">
					<label class="control-label col-sm-2" for="product-name">Product
						Name:</label>
					<div class="col-sm-10">
						<input class="form-control" id="product-name" name="productName" value="${newProduct.productName}"
				...
				<div class="form-group">
					<label class="control-label col-sm-2" for="product-price">Product
						Price:</label>
					<div class="col-sm-10">
						<input class="form-control" id="product-price" name="price" value="${newProduct.price}"
				...
				<div class="form-group">
					<label class="control-label col-sm-2" for="product-desc">Product
						Description:</label>
					<div class="col-sm-10">
						<textarea class="form-control" id="product-desc"
							placeholder="Enter Product Description" name="description" value="${newProduct.description}"
							></textarea>
					</div>
				</div>
